...
static const _BotWaypoint_type_support_symbol_names_t _BotWaypoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bot_waypoint_msgs, msg, BotWaypoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bot_waypoint_msgs, msg, BotWaypoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bot_waypoint_msgs, msg, BotWaypoint)() {
  return &::bot_waypoint_msgs::msg::rosidl_typesupport_c::BotWaypoint_message_type_support_handle;
}
